...
def test_usage_tracker_accumulates_tokens_and_costs():
    ...
    record_usage("deepseek/deepseek-chat-v3.2", 1000, 500, 1.25)
    record_usage("deepseek/deepseek-chat-v3.2", 500, 500, 0.75)
    ...
    assert int(row["call_count"]) == 2
    assert row["total_latency_seconds"] == 2.0
