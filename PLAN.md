...
# V4 Plan — Engagement, Threading & Growth
...
### V4.1 — Final Answer redesign (prompt)
...
### V4.2 — Session thread view in sidebar
...
### V4.3 — CommandBar empty-state improvement
...
### V4.4 — Authentication (sign-in / user accounts)
...
### V4.5 — Export: include full debate, not just final answer
