...
to `main`. v7.0 - Cleanup & Follow-up Flow Fixes (7.0.1 Done; 7.0.2-7.0.8 Planned) — in progress
on `PLAN_v7.0` branch.
...
| v7.0 | Cleanup & Follow-up Flow Fixes | Fix follow-up flow (redundant button, post-submit screen, collapse previous answer into Question card, clarification subtitle, Continue reverting to home, multi-level lineage, team-picker lock) and Scorer badge color confusion | In Progress (7.0.1 Done) |
...
## v7.0 Cleanup & Follow-up Flow Fixes - In Progress
...
| 7.0.2 | Fix the confusing post-submit ("Team is working…") screen | Planned |
| 7.0.3 | Collapse previous Final Answer into Question card after Clarification; "Live Follow-up Run" primary | Planned |
| 7.0.4 | Remove low-value clarification reasoning subtitle (UI only) | Planned |
| 7.0.5 | Continue on follow-up clarification must not revert to empty home hero | Planned |
| 7.0.6 | Fix Scorer badge red `▼` first-score color/direction confusion | Planned |
