...
**In development:** v6.3 - Mobile Follow-up & Debate View Fixes (6.3.1/6.3.3
done on this branch, not yet deployed beyond 6.3.1; 6.3.2 descoped to a
sort-only fix after the badge/score plumbing was reviewed and reverted);
v6.2 remaining items 6.2.7/6.2.8/6.2.9 still open in parallel; v6.4 queued next
...
| v6.3 | Mobile Follow-up & Debate View Fixes | Bug-fix session: mobile follow-up flow, Full Debate transcript view, saved-session team labeling, OpenRouter call reliability and title-generation cost trimming, sidebar follow-up chronological ordering | Done (6.3.1 done, 6.3.2 descoped to sort-only, 6.3.3 done) |
...
## v6.2 Pre-Launch Polish: Rebrand, SEO Foundation, Legal Pages, and OG Sharing - In Progress
...
| 6.3.2 | Follow-up Thread History & Ordering | Descoped (sort-only) |
