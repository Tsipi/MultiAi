...
export function CommandBarTeamAvatars({ team, disabled, showRoles, onAddTeamMember, onOpenAdvanced }: Props) {
  return (
    <div className="flex max-w-[min(100%,280px)] shrink-0 items-center justify-end gap-1.5 sm:max-w-none">
      <div
        className={cn(
          "flex overflow-x-auto rounded-xl border border-transparent sm:max-w-none",
          showRoles ? "gap-2 py-1 pl-1 pr-1 items-start" : "max-w-[220px] items-center gap-1 py-0.5 pl-0.5 pr-1",
